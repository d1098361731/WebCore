   ...
   public  class SugarDbContext
    {
        ...
        {
            get { return _connectionString = AppSettingsHelpper.ConnectionString; }
        ...
        {
            get {
                switch (AppSettingsHelpper.DbType)
                {
                    case "MySql":
                        dbType = DbType.MySql;
                        break;
        ...
        public SugarDbContext():this(true) {  }

        public SugarDbContext(bool IsAutoCloseConnection)
        {
...
")
        ...
        /// <returns>返回值</returns>
        public static SugarDbContext GetDbContext(bool blnIsAutoCloseConnection = true)
        {
            return new SugarDbContext(blnIsAutoCloseConnection);
        }
